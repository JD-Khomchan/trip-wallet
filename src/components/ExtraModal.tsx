          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-100 rounded-2xl pl-11 pr-4 py-3.5 font-bold focus:bg-white focus:border-secondary transition-all outline-none"
                style={{ fontSize: '16px' }}
              />
            </div>
          </div>
